####################################### WINDOWS/DEV #######################################
run:
	./deps/tailwind.exe -i tailwind.css -o ./content/static/style.css
	nu genposts.nu
...
dependencies-win:
	mkdir -p ./deps
	curl -L https://github.com/tailwindlabs/tailwindcss/releases/download/v3.4.17/tailwindcss-windows-x64.exe -o ./deps/tailwind.exe
...
# templ
	curl -L https://github.com/a-h/templ/releases/download/v0.3.1020/templ_Linux_x86_64.tar.gz -o ./deps/installs/templ.tar
